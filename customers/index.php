        ...
        <tbody>
            <?php foreach ($data as $row): ?>
                <tr>
                    ...
                    <td><?= $row['village'] ?></td>
                    <td>
                        <button class="btn btn-warning btn-sm editBtn" data-id="<?= $row['CustomerID'] ?>">✏️</button>
                        <button class="btn btn-danger btn-sm deleteBtn" data-id="<?= $row['CustomerID'] ?>">🗑️</button>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    ...
                    <small class="text-muted">Manage all your honey Customers</small>
                </div>
                    ...
                    <div class="modal-body">
                        <form method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="CustomerID" id="eid">
            ...
            document.addEventListener("click", e => {
                if (e.target.classList.contains("editBtn")) {
                    fetch(`?edit=${e.target.dataset.id}`)
                        .then(res => res.json())
                        .then(data => {
                            document.getElementById("eid").value = data.CustomerID;
